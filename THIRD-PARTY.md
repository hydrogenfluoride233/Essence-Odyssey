...
本清单由作者依据自己的记录整理，可能仍有遗漏。⚠️「等 / 其他」这类概括说法**不能替代**上面
按条列出的署名——Botania License、CC BY-NC-SA 4.0、MIT 等许可都要求明确署名到具体作者。

若你是本整合包中某个素材、译文或代码的作者而未被列入，或希望以别的方式处理你的作品，
请通过项目页或仓库 Issue 联系，我会补充署名，或按你的意愿替换 / 移除。
